...
def betterEvaluationFunction(currentGameState):
  ...
  foodDistance = []
  minFoodDistance = 10000000
  minGhostDistance = 10000000
  minCapsuleDistance = 1000000

  for capsule in capsules:
    if minCapsuleDistance > manhattanDistance(capsule, newPos):
      minCapsuleDistance = manhattanDistance(capsule, newPos)
  ...
  for ghost in newGhostStates:
      ...
      elif minGhostDistance < 3 and ghost.scaredTimer > 0:
        ghostScore += 1000000
  ...
  for state in newGhostStates:
    ...
    if state.scaredTimer == 0 and dist < 3:
      ghostScore -= 1.0 / (10.0 - dist);
       
  #score += 1.0 / (1 + len(newFood.asList())) + 1.0 / (1 + foodDist)
  #          + ghostScore + currentGameState.getScore()
