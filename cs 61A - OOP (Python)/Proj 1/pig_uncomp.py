...
'''
def select_strategy():
    return make_die_specific_strategy(20)
'''
def other(who):
...
def run_strategy_experiments():
    ...
    #eval_strategy_range(make_die_specific_strategy, 5, 35)
    #eval_strategy_range(make_pride_strategy, 0, 3)
    eval_strategy_range(test_final_strategy, 5, 35)
...
def make_die_specific_strategy(four_side_goal, six_side_goal=20):
    ...
    def strategy(score, opponent_score):
        def plan(turn):
            if(score + opponent_score) % 7 == 0 and score!=0 and opponent_score!=0:
                if turn >= four_side_goal:
                    return hold
                else:
                    return roll
            else:
                if turn >= six_side_goal:
                    return hold
                else:
                    return roll
        return plan
...
def make_pride_strategy(margin, turn_goal=20):
    ...
    def strategy(score, opponent_score):
        def plan(turn):
            if turn >= turn_goal and score - opponent_score >= margin:
                return hold
            else:
                return roll
        return plan
    ...
    #"*** YOUR CODE HERE ***"
        def plan(turn):
            ...
            if 100 - score < turn_goal:
                new_goal = 100 - score
            if turn >= new_goal or (score+opponent_score)%7==0:
                return hold
            else:
                return roll
        return plan
