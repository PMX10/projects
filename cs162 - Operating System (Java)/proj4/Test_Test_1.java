...
public class Test_Test_1 {
	...
	static int port = 15790;	// has to change the port number each time running slave server
	
	int run_1_correct = 0;
	static int run_1_expected = 10;
	...
	public void run_1() throws Exception{
		...
		//=======================================================================================//
		//   	SEND "put(3,7)" RECEIVED "ready"	(ignoreNext = false)						
		//=======================================================================================//
		...
		message = new KVMessage("putreq", "3", "7");
		...
		//=======================================================================================//
		//			SEND "commit" RECEIVED "ack"	(ignoreNext = false)							
		//=======================================================================================//
		sock = null;
		try {
		...
		//=======================================================================================//
		//		SEND "get(3)" RECEIVED "resp"	(ignoreNext = false)							
		//=======================================================================================//
		sock = null;
		try {
			sock = new Socket(server, port);
		...
		message = new KVMessage("getreq", "3");
		...
		//=======================================================================================//	
		//				SEND "del(3)" RECEIVED "ready"	(ignoreNext = false)							
		//=======================================================================================//
		sock = null;
		try {
			sock = new Socket(server, port);
		...
		message = new KVMessage("delreq", "3");
		message.setTpcOpId("123");
		...
		//=======================================================================================//	
		//								SEND "ignoreNext" RECEIVED "resp"	(ignoreNext = false)							
		//=======================================================================================//
		sock = null;
		try {
			sock = new Socket(server, port);
		...
		message = new KVMessage("ignoreNext");
		message.setTpcOpId("123");
		...
		//=======================================================================================//	
		//								SEND "put(1,2)" RECEIVED "abort"	(ignoreNext = true)						
		//=======================================================================================//
		sock = null;
		try {
			sock = new Socket(server, port);
		...
		message = new KVMessage("putreq", "1", "2");
		message.setTpcOpId("123");
		...
		//=======================================================================================//	
		//								SEND "put(1,2)" RECEIVED "ready"	(ignoreNext = false)						
		//=======================================================================================//
		sock = null;
		try {
			sock = new Socket(server, port);
		...
		System.out.println(run_1_correct);
		System.out.println(run_1_expected);
		assertEquals(run_1_correct, run_1_expected);
	}
