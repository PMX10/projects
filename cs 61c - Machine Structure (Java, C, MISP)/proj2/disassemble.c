...
void disassemble(inst_t inst)
{
  ...
  case 0x0: // opcode == 0x0 (SPECIAL)
    ...
    case 0x3: // funct == 0x3 (sra) *
      printf("sra\t$%d,$%d,$%d\n", inst.rtype.rd, (int) inst.rtype.rt, inst.rtype.shamt);
      break;
    ...
    case 0x2a: // funct == 0x2a (slt) *
      printf("slt\t$%d,$%d,$%d\n", inst.rtype.rd, (int) inst.rtype.rs, (int) inst.rtype.rt);
      break;
  ...
  case 0x4: // opcode == 0x4 (beq) *
    printf("beq\t$%d,$%d,%d\n", inst.itype.rs, inst.itype.rt, (int) inst.itype.imm*4);
    break;
  ...
  case 0x9: // opcode == 0x9 (addiu) *
    printf("addiu\t$%d,$%d,%d\n", inst.itype.rt, inst.itype.rs, (int) inst.itype.imm);
    break;
  
  case 0xa: // opcode == 0xa (slti) *
    printf("slti\t$%d,$%d,0x%x\n", inst.itype.rt, (int) inst.itype.rs, (int) inst.itype.imm);
    break;
  ...
  case 0x20: // opcode == 0x20 (lb) *
    printf("lb\t$%d,$%d($%d)\n", inst.itype.rt, (int) inst.itype.imm, inst.itype.rs);
    break;
